    ...
    <div className="bg-white rounded-2xl shadow-lg p-5 w-[350px] flex flex-col items-center space-y-4">
      ...
      <div className="w-full flex gap-2 mt-2">
        ...
        <button
          ...
          className="flex-1 bg-red-500 hover:bg-red-600 disabled:bg-red-300 text-white py-2 px-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors"
